...
<%
	OrderDetailVO orderDetailVO = (OrderDetailVO) request.getAttribute("OrderDetail");
...
<body>
<a href='<%=request.getContextPath()%>/backend/orderDetail/orderDetail.jsp'><input type="button" value="回訂單頁面"></a>
	<table>
		<ul>
			<li>
